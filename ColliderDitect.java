...
public class ColliderDitect{
	...
	public Vector2 getAbsPhysld(Bullet b){
		Vector2 ld;
		ld =new Vector2(b.getPhyslu().x, b.getPhysrd().y);
		ld.add(b.getCenterPos(), ld);
		return ld;
	}
	...
	public Vector2 getAbsPhysru(Bullet b){
		Vector2 ru;
		ru =new Vector2(b.getPhysrd().x, b.getPhyslu().y);
		ru.add(b.getCenterPos(), ru);
		return ru;
	}
	...
	public Vector2 getAbsPhyslu(Bullet b){
		Vector2 lu;
		lu = new Vector2();
		lu.add(b.getCenterPos(), b.getPhyslu());
		return lu;
	}
	...
	public Vector2 getAbsPhysrd(Bullet b){
		Vector2 rd;
		rd = new Vector2();
		rd.add(b.getCenterPos(), b.getPhysrd());
		return rd;
	}
	...
	public boolean onWallDitectR(CharacterData c){
		...
		rdPosXd=(int)((rd.x+6)/64);  rdPosY=(int)(rd.y/64);
		ruPosXd=(int)((ru.x+6)/64);  ruPosY=(int)(ru.y/64);
	...
	public boolean onWallDitectL(CharacterData c){
		...
		ldPosXd=(int)((ld.x-6)/64);  ldPosY=(int)(ld.y/64);
		luPosXd=(int)((lu.x-6)/64);  luPosY=(int)(lu.y/64);
	...
	public CharacterData attackToEnemyByBullet(Bullet b){
		Vector2 attLu, attRd;
		attLu = new Vector2();   attRd = new Vector2();
		//attDif1 = new Vector2(25,-30);  attDif2 = new Vector2(80,20);
		attLu.add(b.getCenterPos(),b.getPhyslu());
		attRd.add(b.getCenterPos(),b.getPhysrd());
		int rLefter,lRighter,uDowner,dUpper;
		...
		return GameManager.charaList.get(0);//当たらなければプレイヤー自身を返す
	}
