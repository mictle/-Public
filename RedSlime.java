...
import java.awt.*;
/*基本になる敵。道なりに行くクリボーと同じムーブをする。ブルースライムよりちょっと強い。*/
public class RedSlime extends Enemy{
  ...
  */
  ...
  //性質上こいつには向きも指定したい
  public RedSlime(Vector2 summonPos, int lr){
    super(20, 20, 100, false, lr, summonPos, new Vector2(-32,-32), new Vector2(64, 64), new Vector2(-30,-30), new Vector2(30,30));
    images[0][0] = Toolkit.getDefaultToolkit().getImage("./irusts/redSlime_walk_l.gif");
    images[0][1] = Toolkit.getDefaultToolkit().getImage("./irusts/redSlime_walk_r.gif");
    images[1][0] = Toolkit.getDefaultToolkit().getImage("./irusts/redSlime_damage_l.png");
    images[1][1] = Toolkit.getDefaultToolkit().getImage("./irusts/redSlime_damage_r.png");
